...
namespace vmv
{
    ...
    VkResult VMVSwapChain::acquireNextImage(uint32_t* imageIndex)
    {
        vkWaitForFences(
    ...
    VkResult VMVSwapChain::submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex)
    {
    ...
    void VMVSwapChain::createImageViews()
    {
    ...
    void VMVSwapChain::createRenderPass()
    {
    ...
    void VMVSwapChain::createFramebuffers()
    {
    ...
    void VMVSwapChain::createSyncObjects()
    {
    ...
    VkSurfaceFormatKHR VMVSwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
    {
    ...
    VkPresentModeKHR VMVSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
    {
    ...
    VkExtent2D VMVSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
    {
    ...
    VkFormat VMVSwapChain::findDepthFormat()
    {
